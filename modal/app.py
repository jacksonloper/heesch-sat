...
# Build timestamp: 2026-01-06T15:30:00Z - fixed periodic solver with max_period and unit_vars constraints
image = (
    ...
    .run_commands(
        "echo 'Build: 2026-01-06T15:30:00Z' && cd /app/src && make clean render_witness gen",
